...
async def create_chat(
    ...
    try:
        ...
        chat_id = await deps["command_bus"].dispatch(command)
...
async def get_my_chats(
    ...
    return await deps["query_bus"].query(query)
...
async def get_unread_chats_count(
    ...
    count = await deps["query_bus"].query(query)
...
async def get_chat(
    ...
    chat = await deps["query_bus"].query(query)
...
async def send_message(
    ...
    try:
        ...
        message_id = await deps["command_bus"].dispatch(command)
