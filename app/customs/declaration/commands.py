...
class CreateCustomsDeclarationCommand(Command):
    ...
    declaration_id: uuid.UUID = Field(default_factory=uuid.uuid4, description="Generated declaration ID")
    user_id: uuid.UUID
...
class CopyCustomsDeclarationCommand(Command):
    ...
    new_declaration_id: uuid.UUID = Field(default_factory=uuid.uuid4)
    user_id: uuid.UUID
