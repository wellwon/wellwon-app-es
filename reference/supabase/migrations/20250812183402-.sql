-- Этап 1 исправленный: Расширение базы данных для Telegram супергрупп
...
-- 6. Создаем функцию для проверки developer статуса (избегаем рекурсию RLS)
...
-- 7. Создаем RLS политики для telegram_supergroups
...
-- 8. Создаем RLS политики для telegram_group_members
...
-- 9. Создаем функцию обновления updated_at для telegram_supergroups
